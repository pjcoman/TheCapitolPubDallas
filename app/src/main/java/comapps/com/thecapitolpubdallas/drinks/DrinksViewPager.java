    ...
    class MyAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                ...
                fragment = new BeersListViewFragmentDraught();
            }
            if (position == 1) {

                fragment = new BeersListViewFragmentCombo();
            }
            if (position == 2) {

                fragment = new BeersListViewFragmentUSA();
            }
            if (position == 3) {

                fragment = new BeersListViewFragmentTexas();
            }
            if (position == 4) {

                fragment = new BeersListViewFragmentImportBeers();
            }
            if (position == 5) {

                fragment = new BeersListViewFragmentDomesticBeers();
            }
            if (position == 6) {

                fragment = new BeersListViewFragmentBeersToShare();
            }
            if (position == 7) {

                fragment = new BeersListViewFragmentCiderBottles();
            }

            if (position == 8) {

                fragment = new SeasonalDrinksListViewFragment();
            }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            String[] tabTitles = {"DRAUGHT BEER", "COMBINATIONS", "USA CRAFT", "TEXAS CRAFT", "IMPORT BOTTLES&CANS",
                    "DOMESTIC BOTTLES&CANS", "BEERS TO SHARE", "BOTTLED CIDERS", "SEASONAL DRINKS"};
